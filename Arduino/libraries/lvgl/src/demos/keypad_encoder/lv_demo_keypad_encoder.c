...
void lv_demo_keypad_encoder(void)
{
    ...
    tv = lv_tabview_create(lv_scr_act(), LV_DIR_TOP, 25);
...
static void msgbox_create(void)
{
    static const char * btns[] = {"Ok", "Nok", ""};
    lv_obj_t * mbox = lv_msgbox_create(NULL, "Hi. Welcome to the", "kbd & encoder demo", btns, false);
