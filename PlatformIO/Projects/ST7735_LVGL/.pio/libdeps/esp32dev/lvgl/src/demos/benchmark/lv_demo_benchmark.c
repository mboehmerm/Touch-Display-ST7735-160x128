...
static scene_dsc_t scenes[] = {
    ...
    {.name = "Image chorma keyd reclr",      .weight = 3, .create_cb = img_ckey_recolor_cb},  // modified
    ...
    {.name = "Image RGB rotate a. a.",       .weight = 3, .create_cb = img_rgb_rot_aa_cb},    // modified
    {.name = "Image ARGB rotate",            .weight = 5, .create_cb = img_argb_rot_cb},
    {.name = "Image ARGB rotate a. a.",      .weight = 5, .create_cb = img_argb_rot_aa_cb},   // modified
    {.name = "Image RGB zoom",               .weight = 3, .create_cb = img_rgb_zoom_cb},
    {.name = "Image RGB zoom a. a.",         .weight = 3, .create_cb = img_rgb_zoom_aa_cb},   // modified
    {.name = "Image ARGB zoom",              .weight = 5, .create_cb = img_argb_zoom_cb},
    {.name = "Image ARGB zoom a. a.",        .weight = 5, .create_cb = img_argb_zoom_aa_cb},  // modified
